...
<input type="radio" value="1" <?php If ($Func =="1")  { echo "checked";}?> name="Func" onclick="Show(1)">傳送訊息&nbsp;&nbsp;                                              
<input type="radio" value="2" <?php If ($Func =="2") { echo "checked";} ?> name="Func" onclick="Show(2)">查詢狀態&nbsp;&nbsp;
<input type="radio" value="3" <?php If ($Func =="3") { echo "checked";} ?> name="Func" onclick="Show(3)">接收訊息
</div>

<hr>
  <table border="0" width="60%" align="center" style="background-color: #FFFFCC">
    <caption><font size="4" color="#0000FF"><b>登入帳號</b></font></caption>
    <tr>
      <td width="15%" align="right">IP：</td>
      <td width="25%" align="left">
		<input type="text" name="IP" size="20" value="<?php echo $SNS_IP;?>"></td>
    ...
    <tr>
      ...
      <td width="25%" align="left">     
        <input type="text" name="Account" size="20" maxlength="5" value="<?php echo $Account;?>"></td>
      <td width="14%" align="right">     
        密碼：</td>
      <td width="44%" align="left">     
        <input type="text" name="Password" size="20" maxlength="5" value="<?php echo $Password;?>"></td>
    </tr>
    <tr>
...
<p>
 ...
 <div id="SendForm" style="<?php echo $ShowSendForm?>">
  <table border="0" width="60%" align="center" style="background-color: #FFFFCC">
    <caption><font size="4" color="#0000FF"><b>傳送訊息</b></font></caption>
    <tr>
      <td width="15%">手機號碼：</td>
...
<div id="QueryForm" style="<?php echo $ShowQryForm?>"> 
  <table border="0" width="60%" align="center" style="background-color: #FFFFCC">
    <caption><font color="#0000FF" size="4"><b>查詢狀態</b></font></caption>
    <tr>
      <td width="15%">手機號碼：</td>
...
<div id="RecvForm" style="<?php echo $ShowRecvForm?>">  
  <table border="0" width="60%" align="center" style="background-color: #FFFFCC" id="table1">
    <caption><font size="4" color="#0000FF"><b>接收訊息</b></font></caption>
    <tr>
      <td width="20%">傳送手機號碼：</td>
      <td width="79%" align="left">
		<input type="text" name="SendMsisdn" size="20" value="<?php echo $SendMsisdn;?>" readonly></td>
    </tr>
    <tr>
      <td width="20%">接收手機號碼：</td>
      <td width="79%" align="left">
		<input type="text" name="RecvMsisdn" size="20" value="<?php echo $RecvMsisdn;?>" readonly></td>
    </tr>
    <tr>
      <td width="20%">接收訊息內容：
      </td>
